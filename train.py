...
def parse_args():
    ...
    parser.add_argument('--trainset_dir', type=str, default='/media/lab425/sdb/dataset/LFSR/data_for_training/SR_5x5_4x_16/')
    parser.add_argument('--testset_dir', type=str, default='/media/lab425/sdb/dataset/LFSR/data_for_test/')
    parser.add_argument('--testdata', type=str, default='SR_5x5_4x/')
    parser.add_argument('--parrallel', type=int, default=1)
